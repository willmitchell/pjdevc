...
#
$db = <<END;
gradle|GRADLE_HOME|http://services.gradle.org/distributions/gradle-1.3-bin.zip|1.3|1
groovy|GROOVY_HOME|http://dist.groovy.codehaus.org/distributions/groovy-binary-1.8.3.zip|1.8.3|1
grails|GRAILS_HOME|http://dist.springframework.org.s3.amazonaws.com/release/GRAILS/grails-2.2.0.zip|2.2.0|1
